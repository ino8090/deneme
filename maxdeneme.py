...
def get_local_state():
    """Yerel state_maxdeneme.json dosyasından son durumu okur."""
...
def update_local_state(index, seconds):
    """Son konumu yerel state_maxdeneme.json dosyasına kaydeder."""
    try:
...
def start_m3u_stream():
    ...
    while True:
        ...
        print("=" * 60)
        print("📺 maxdeneme Canlı Aktarım Yayını (1080p 30fps - 2000k) Başlatılıyor")
